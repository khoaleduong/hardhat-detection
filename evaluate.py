...
from src.dataset.dataloader import build_test_dataloader
...
def main():
    ...
    # 1. Test DataLoader
    test_loader = build_test_dataloader(data_dir=DATA_DIR, batch_size=BATCH_SIZE, num_workers=NUM_WORKERS, pin_memory=PIN_MEMORY, class_offset=CLASS_OFFSET, num_classes=NUM_CLASSES)
    ...
    # 4. Evaluate
    evaluate(model=model, loader=test_loader, device=DEVICE, class_names=CLASS_NAMES)
